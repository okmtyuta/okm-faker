...
exports.factory = exports.replaceRefExp = exports.getAlphabetBetween = void 0;
const UPPERS = [
    "A",
    "B",
    "C",
...
const getAlphabetBetween = (left, right) => {
...
exports.getAlphabetBetween = getAlphabetBetween;
const replaceRefExp = (char) => {
    if (char === "*") {
...
exports.replaceRefExp = replaceRefExp;
const factory = (pattern) => {
    ...
    for (const source of sources) {
        ...
        if (bracket) {
            stack = stack + (0, exports.replaceRefExp)(source);
            continue;
        }
        if (!bracket) {
            output = output + (0, exports.replaceRefExp)(source);
            continue;
        }
    }
    console.log(output);
